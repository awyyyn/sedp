...
import { headingClasses, officesOptions } from "@/lib/constant";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Create a new admin account with secure credentials and send them via email."
        />
      </Helmet>
      <Card className="rounded-md shadow-md mb-10 ">
        <CardHeader className="flex rounded-none bg-[#A6F3B2] flex-col items-start">
          ...
          <p>
            Generate secure credentials for a new administrator and send them
            via email.
          </p>
        </CardHeader>
