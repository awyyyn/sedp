  ...
  return (
    <>
      <Helmet>
        ...
        <title>System User | Admin</title>
        <meta
          name="description"
          content="View detailed information about a system user, including personal and security details."
        />
      </Helmet>
      <div className="space-y-6 pb-10">
        ...
        <Card>
          <CardHeader className="px-6 pt-4">
            <h1 className="flex items-center gap-2">
              <Icon icon="hugeicons:office" width="24" height="24" />
              Office
            </h1>
          </CardHeader>
          <Divider />
          <CardBody className="p-6 space-y-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <p className="font-medium">{data.systemUser.office}</p>
              </div>
            </div>
          </CardBody>
        </Card>
