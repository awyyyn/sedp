...
export default function SemesterSubmissions() {
	...
	return (
		<>
			<Helmet>
				...
				<title>Semester Documents | Admin</title>
				<meta
					name="description"
					content="View and manage semester document submissions from scholars in the admin panel."
				/>
			</Helmet>
					...
					<div className="px-5 flex justify-between">
						<div className="leading-loose">
							...
							<p className="text-sm leading-loose text-gray-400">
								Overview of scholars and their submitted semester documents.
							</p>
						</div>
					</div>
					<Table
