			...
			{activeStep === steps.length ? (
				<div className="gap-2 justify-center flex flex-col items-center pt-5">
					...
					<Button
						...
						onPress={() => navigate("/admin/login", { replace: true })}>
						Continue to Log in
					</Button>
				</div>
			) : (
									...
									{activeStep === 0 ? (
										...
										<div className="space-y-2">
											...
											<div className="  flex justify-between   items-center px-1">
												...
												<p className="text-medium">+63 {values.phoneNumber}</p>
											</div>
											...
											<div className="  flex justify-between   items-center px-1">
												<p className="text-gray-500 md:min-w-[50%]">Barangay</p>
												<p className="text-medium">{values.barangay}</p>
											</div>

											<div className="  flex justify-between   items-center px-1">
												<p className="text-gray-500 md:min-w-[50%]">Password</p>
