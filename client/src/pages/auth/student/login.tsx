...
import { scholarNotificationAtom, systemUserAtom } from "@/states";
...
export default function StudentLogin() {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Log in | SEDP</title>
        <meta
          name="description"
          content="Log in to the SEDP student portal to manage your system."
        />
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            if (mfaEnabled) {
              verifyTOTP({
                variables: {
                  secret: studentUser?.mfaSecret || systemUser?.mfaSecret,
                  token: values.otp,
                },
              });
            } else {
                    ...
                    <>
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          ...
                          similar), and enter the code generated for your
                          account. This code changes every 30 seconds for added
                          security
                        </p>
                      </div>
                      <InputOtp
