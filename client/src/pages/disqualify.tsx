...
export default function DisqualifyPage() {
	return (
		<>
			<Helmet>
				<meta charSet="utf-8" />
				<title>Disqualified | SEDP</title>
				<meta
					name="description"
					content="Your scholarship application has been disqualified due to missing documents or not meeting the requirements."
				/>
					...
					<CardBody className="gap-5 text-center py-8">
						...
						<div className="space-y-2">
							...
							<p className="text-default-600">
								We regret to inform you that your scholarship application has
								been disqualified.
							</p>
						</div>
