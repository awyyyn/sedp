				...
				<div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 8px rgba(0,0,0,0.05);">
					...
					<div style="padding: 30px 25px; color: #333333;">
						...
						<div style="text-align: center; margin: 30px 0;">
							<a href="https://sedp-ligao.example.com/login" style="background-color: #4CAF50; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">Login to Your Account</a>
						</div>
